...
def train_model_per_farm(farm,model,df,features_list,predictions_column,predictions_df):
...
for farm in range(1,7):
  ...
  train_model_per_farm(farm,model,prepared_df,features_list,predictions_column,predictions_df)
...
for dist in chunks:
  model=GradientBoostingRegressor(random_state=0)
  train_model_per_dist(dist,model,prepared_df,features_list,predictions_column,predictions_df)
